repository.js
------------------
Fernando Felix do Nascimento Junior (http://fjacademic.wordpress.com)

A simple lib for create JavaScript applications. 
It uses MTV (Model, Template, View) and Repository design partners.

Keywords: mtv, mvc, reposotory, partners, javascript
